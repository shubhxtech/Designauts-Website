    ...
    <div className="min-h-screen bg-black text-white flex items-center justify-center px-4 py-12">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-5xl z-10">
        ...
        <div className="flex flex-col items-center justify-center text-center space-y-4 p-8 rounded-lg shadow-lg">
          <img
            src="https://cc.iitmandi.co.in/_next/image?url=%2Fassets%2Fcc_core%2FVivek_Aggarwal_Cultural_Secretary.jpg&w=256&q=75" // Replace with your image URL
            alt="Profile"
            className="w-32 h-32 rounded-full object-cover mb-4 border-white border-4"
          />
          <h3 className="text-2xl font-bold">Vivek Aggarwal</h3>
          <p className="text-gray-400">Cultural Secretary</p>
          <p className="text-gray-400">Phone: 7477899100</p>
